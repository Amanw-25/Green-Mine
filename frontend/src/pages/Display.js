...
const EV_CONSTANT = 0.2;
const GREEN_FUEL_CONSTANT = 0.5;
        ...
        <div className="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-300">
          <div className="bg-gradient-to-r from-blue-300 to-teal-300 text-white py-8">
            <h1 className="text-5xl font-bold text-center">
              CarbMine Project Calculations
            </h1>
            <p className="text-lg text-center mt-2 font-medium">
              An in-depth look at the calculations used in the CarbMine project,
              detailing emissions and neutralization pathways.
            </p>
          </div>
          ...
          <div className="p-10 space-y-10">
            ...
            <section className="bg-gray-50 py-12">
              ...
              <div className="space-y-6">
                {/* Reference 1 */}
                <motion.div
                  className="bg-gray-100 p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-transform duration-300 transform hover:scale-105"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
